...
function readIPTCData (file, startOffset, sectionLength) {
  console.log('readIPTCDatareadIPTCDatareadIPTCDatareadIPTCData')
  var dataView = new DataView(file)
  var data = {}
  ...
  switch (type) {
    ...
    case 5: // rational = two long values, first is numerator, second is denominator
      if (numValues === 1) {
        ...
        val = new Array(Math.round(numerator / denominator))
        ...
        for (n = 0; n < numValues; n++) {
          ...
          if (!Math.round(numerator / denominator)) {
            vals[n] = new Array(1)
          } else {
            vals[n] = new Array(Math.round(numerator / denominator))
          }
